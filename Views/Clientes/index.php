...
<div class="container">
  <form id="indexClientes" class="col-md-12" method="POST">
    <div class="text-center text-primary">
      <h1><strong><span class="glyphicon glyphicon-user"></span> Relação de Clientes </strong></h1>
    </div>
    ...
    <div class="col-md-8">
      ...
      <div>
        <br />
        <div>
          <a href="../Clientes/novo" class="btn btn-primary btn-md">
    ...
    <div class="col-md-4">
      <br />
      <button type="submit" form="indexClientes" class="btn btn-link btn-lg"><span class="glyphicon glyphicon-zoom-in"></span> Pesquisar</button>
    </div>
