...
<div class="container">
  <form id="indexGrupos" class="col-md-12" method="POST">
    <div class="text-center text-primary">
      <h1><strong><span class="glyphicon glyphicon-user"></span> Relação de Grupos </strong></h1>
    </div>
    ...
    <div class="col-md-8">
      ...
      <div>
        <br />
        <div>
          <a href="../Grupos/novo" class="btn btn-primary btn-md">
    ...
    <div class="col-md-4">
      <br />
      <button type="submit" form="indexGrupos" class="btn btn-link btn-lg"><span class="glyphicon glyphicon-zoom-in"></span> Pesquisar</button>
    </div>
