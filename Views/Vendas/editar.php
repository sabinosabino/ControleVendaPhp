...
<div class="container">
  ...
  <div class="text-center text-primary">
    <h1><strong><span class="glyphicon glyphicon-th"></span> Edição Lançamento de Vendas </strong></h1>
  </div>
  <form id="Vendas" method="POST" action="../Salvar" onsubmit="return ValidaVendas()">
    ...
    <div class="form-group">
      <div class="col-md-2">
        ...
        <input type="text" class="form-control moeda" id="valor_venda" name="valor_venda" required placeholder="R$ 0,00" required value=<?php echo $dadosModel[0]["valor_venda"] ?>>
      </div>
    </div>
    <div class="form-group">
      <div class="col-md-12">
        <label for="detalhe_venda">Detalhes</label>
        <textarea type="text" class="form-control" id="detalhe_venda" name="detalhe_venda" placeholder="Insira mais detalhes" required><?php echo $dadosModel[0]["detalhe_venda"] ?></textarea>
        </br>
      </div>
    </div>
    <div class="form-group">
