...
<div class="container">
  ...
  <div class="text-center text-danger">
    <h1><strong><span class="glyphicon glyphicon-th"></span> Excluir Lançamento de Pagamentos </strong></h1>
  </div>
  <form id="Vendas" method="POST" action="../deletar">
    ...
    <div class="form-group">
      <div class="col-md-2">
        ...
        <input type="text" class="form-control moeda" id="valor_pago"  readonly name="valor_pago" required placeholder="R$ 0,00" required value=<?php echo $dadosModel[0]["valor_pago"] ?>>
      </div>
    </div>
    <div class="form-group">
      <div class="col-md-12">
        <label for="detalhes_pagamento">Detalhes</label>
        <textarea type="text" class="form-control" id="detalhes_pagamento" readonly name="detalhes_pagamento" placeholder="Insira mais detalhes" required><?php echo $dadosModel[0]["detalhes_pagamento"] ?></textarea>
        </br>
      </div>
    </div>
    <div class="form-group">
