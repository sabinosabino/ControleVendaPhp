...
<div class="container">
  <form id="indexPagamentos" class="col-md-12" method="POST">
    <div class="text-center text-primary">
      <h1><strong><span class="glyphicon glyphicon-th"></span> Relação de Pagamentos </strong></h1>
    </div>
    ...
    <div class="col-md-2">
      <br />
      <button type="submit" form="indexPagamentos" class="btn btn-link btn-lg"><span class="glyphicon glyphicon-zoom-in"></span> Pesquisar</button>
    </div>
    <div class="col-md-2" style="margin-bottom: 25px;">
      <a href="../Pagamentos/novo" class="btn btn-primary btn-md">
